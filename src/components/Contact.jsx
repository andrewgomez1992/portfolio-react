...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/407b4886-1beb-4682-84ad-41ddf78303a0" className='flex flex-col max-w[600px] w-full'>
            <div>
            ...
            <input className='my-4 p-2 bg-[#ccd6f6] rounded' type="email" placeholder='Email' name='name' />
            <textarea className='bg-[#ccd6f6] p-2 rounded' placeholder='Message' name="message" rows="10"></textarea>
