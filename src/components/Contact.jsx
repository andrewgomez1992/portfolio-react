...
const Contact = () => {
  return (
    <div id='contact' name='contact' className='w-full h-screen bg-[#121212] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/407b4886-1beb-4682-84ad-41ddf78303a0" className='flex flex-col max-w[600px] w-100'>
            <div className=''>
                ...
                <p className='text-gray-300 py-4'>Submit the form below or <span className='text-[#29AB87]'>shoot me an email</span> - drewgomez209@gmail.com</p>
            </div>
            ...
            <button className='text-[#BDBDBD] border-2 border-[#29AB87] hover:bg-[#29AB87] hover:border-[#29AB87] hover:text-white px-4 py-3 my-8 mx-auto flex items-center rounded'>Let's join forces</button>
        </form>
    </div>
  )
}
