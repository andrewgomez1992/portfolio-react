...
const Contact = () => {
  return (
    <div
      id="contact"
      name="contact"
      className="w-full h-screen bg-[#121212] flex justify-center items-center p-4 pt-10"
    >
      <form
        method="POST"
      ...
      >
        <div className="">
          <p className="text-4xl font-bold inline border-b-4 border-[#29AB87] text-[#BDBDBD]">
            Contact
          </p>
        ...
        <input
          className="bg-[#eae8e8] p-2 rounded outline-0"
          type="text"
          placeholder="Name"
          name="name"
        />
        <input
          className="my-4 p-2 bg-[#eae8e8] rounded outline-0"
          type="email"
          placeholder="Email"
          name="name"
        />
