...
const Skills = () => {
  return (
    <div id='skills' name='skills' className='w-full h-screen bg-[#121212] text-[#BDBDBD]'>
        {/** Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-[#29AB87]'>Skills</p>
                <p className='py-4'>These are the technologies <span className='text-[#29AB87]'>I've recently</span> worked with</p>
            </div>
