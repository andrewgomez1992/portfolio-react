...
const Work = () => {
  ...
  return (
    <div
      ...
      href="#work"
      name="work"
      className="w-full md:h-screen text-[#BDBDBD] bg-[#121212]"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8 mt-14">
          <p className="text-4xl font-bold inline border-b-4 text-[#BDBDBD] border-[#29AB87]">
            Projects
          </p>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {/** Grid Item */}
          <div
            style={{ backgroundImage: `url(${flix})` }}
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 p-4">
              ...
              <div className="pt-8 text-center">
                <a href="flix-site">
                  <button
                    onClick={() => window.open(flixURL, "_blank")}
                ...
                <a href="flix-code">
                  <button
                    onClick={() => window.open(flixCode, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Code
                  </button>
          ...
          {/** Grid Item */}
          <div
            style={{ backgroundImage: `url(${myadmin})` }}
            className="shadow-md shadow-[#29AB87] group container rounded-md flex justify-center mx-auto content-div"
          >
            {/** Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 p-4">
              ...
              <div className="pt-8 text-center">
                <a href="myadmin-site">
                  <button
                    onClick={() => window.open(myAdminURL, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Demo
                  </button>
                ...
                <a href="myadmin-code">
                  <button
                    onClick={() => window.open(myadminCode, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Code
                  </button>
          ...
          {/** Grid Item */}
          <div
            style={{ backgroundImage: `url(${devspace})` }}
            className="shadow-md shadow-[#29AB87] group container rounded-md flex justify-center mx-auto content-div"
          >
            {/** Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 p-4">
              ...
              <div className="pt-8 text-center">
                <a href="devspace-site">
                  <button
                    onClick={() => window.open(devSpaceURL, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Demo
                  </button>
                ...
                <a href="devspace-code">
                  <button
                    onClick={() => window.open(devspaceCode, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Code
                  </button>
          ...
          {/** Grid Item */}
          <div
            style={{ backgroundImage: `url(${airtravel})` }}
            className="shadow-md shadow-[#29AB87] group container rounded-md flex justify-center mx-auto content-div"
          >
            {/** Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 p-4">
              ...
              <div className="pt-8 text-center">
                <a href="travel-site">
                  <button
                    onClick={() => window.open(airTravelURL, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Demo
                  </button>
                ...
                <a href="travel-code">
                  <button
                    onClick={() => window.open(airtravelCode, "_blank")}
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
                  >
                    Code
                  </button>
